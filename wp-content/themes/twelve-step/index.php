    ...
    <div id="my-body">
        ...
        <div id="content">
            <p><span class="xplode">OK</span><br>So at the beggining of this year, you made several resolutions...as one of them to make several millions within these twelve months<br>well here we are, <?php $a = getdate(); echo $a['mon'] ?> months into 2013, How much have you moved in terms of wealth creation, are you richer, poorer or still just there?</p>
            ...
            <p>The good news about the questions you ask yourself is that they have been asked before, and they have answered before as well</p>
            ...
            <?php if(have_posts()): while(have_posts()): the_post() ?>
                    ...
                    <div class="book"><div class="cover"><img alt="<?php echo the_title(); echo " - cover image"; ?>" src="<?php echo get_post_meta($post->ID, "lead_image", true); ?>" /></div><a class="title" href="<?php the_permalink(); ?>"><?php the_title(); ?></a><span class="book-description"><?php the_content(); ?></span><!-- floating div issue --><div style="clear: both"></div></div>
            ...
            <div id="buy">So! Jump in <span class="button"><a href="<?php page_url("paymentoptions"); ?>">Buy Now</a></span></div>
        </div>
    </div>
    <?php get_footer(); ?>